# TD3 (Twin-Delayed Deep Deterministic Policy Gradient), DDPG (Deep Deterministic Policy Gradient), SAC (Soft Actor Critic), Q-Learning, SARSA and DQN (Deep Q-Network) Reinforcement Learning based mobile robot navigation
